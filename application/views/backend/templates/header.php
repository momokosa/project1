...
<!--===============================================================================================-->
	...
	<?php
	if($title == 'Manage Users' || $title == 'Manage Customers'){
		echo '<link href="'.base_url().'css/mycustom.css" rel="stylesheet" type="text/css">';
		echo '<link href="'.base_url().'css/jquery.dataTables.min.css" rel="stylesheet" type="text/css">';
	}
	?>
...
<body>
	<div id="wrapper">
		<!-- Navigation -->
		<?php $this->view('backend/templates/menu'); ?>
	    <!-- /Navigation -->
